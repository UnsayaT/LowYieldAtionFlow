<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser8.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser8_Test" %>
...
                                        นั้นการตัดสินขั้นสุดท้าย (Final Judgement) ให้ดำเนินการโดย R/K QC
    ...
    <div class="collapse show" id="CL5">
        <div class="card card-body">
            ...
            <div class="card">
                <div class="card-header"><b>*ออกใบ AQI ?</b></div>
                <select class="custom-select wide BgColData" id="SelectS15A1" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide BgColData" id="SelectS15A2" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide BgColData" id="SelectS15A3" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS21" runat="server" CssClass="form-control wideOnly" TextMode="MultiLine" placeholder="กรอกรายละเอียด"></asp:TextBox>
            </div>
