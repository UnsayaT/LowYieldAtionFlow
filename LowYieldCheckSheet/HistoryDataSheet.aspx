<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistoryDataSheet.aspx.cs" Inherits="LowYieldCheckSheet.HistoryDataSheet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
     ...
     <div class="jumbotron">
        <h1 class="text-center login-title" style="font-family: 'Waffle Regular'; font-weight: bold;">LOW YIELD HISTORY DATA SHEET</h1>
    </div>
    ...
    <div class="collapse" id="CL1">
        <div class="card card-body">
            ...
            <div class="row justify-content-center">
                <div class="card text-white bg-primary mb-3 wide1">
                    <div class="card-header text-center">
                        <h5>FYI/FQI</h5>
                    </div>
                    <asp:Label ID="lblStampH1" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                    <asp:Label ID="lblStampH2" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                </div>
                ...
                <div class="card text-white bg-primary mb-3 wide1">
                    ...
                    <asp:Label ID="lblStampH3" runat="server"  CssClass="form-control wide text-center" ></asp:Label>
                    <asp:Label ID="lblStampH4" runat="server"  CssClass="form-control wide text-center" ></asp:Label>
                </div>
                ...
                <div class="card text-white bg-primary mb-3 wide1">
                    ...
                    <asp:Label ID="lblStampH5" runat="server" CssClass="form-control wide text-center"></asp:Label>
                    <asp:Label ID="lblStampH6" runat="server" CssClass="form-control wide text-center"></asp:Label>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox1" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
                    <asp:Label ID="lblStamp1" runat="server" CssClass="form-control wide text-center"></asp:Label>
                    <asp:Label ID="lblStamp2" runat="server" CssClass="form-control wide text-center"></asp:Label>
                </div>
                ...
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox2" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
                    <asp:Label ID="lblStamp3" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                    <asp:Label ID="lblStamp4" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                </div>
                ...
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox3" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
                    <asp:Label ID="lblStamp5" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                    <asp:Label ID="lblStamp6" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                </div>
                ...
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox4" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
                    <asp:Label ID="lblStamp7" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                    <asp:Label ID="lblStamp8" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                </div>
                ...
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox5" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
                    <asp:Label ID="lblStamp9" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                    <asp:Label ID="lblStamp10" runat="server" CssClass="form-control wide text-center" ></asp:Label>
                </div>
                ...
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox7" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
                    <asp:Label ID="lblStamp13" runat="server" CssClass="form-control wide text-center"></asp:Label>
                    <asp:Label ID="lblStamp14" runat="server" CssClass="form-control wide text-center"></asp:Label>
                </div>
                ...
                <div class="card badge-primary text-center mb-3 wide1">
                    ...
                    <%--<asp:TextBox ID="TextBox8" runat="server" BorderColor="Black" CssClass="form-control wide text-center" Height="30px" placeholder="USER ID"></asp:TextBox>--%>
...
                                        นั้นการตัดสินขั้นสุดท้าย (Final Judgement) ให้ดำเนินการโดย R/K QC
     ...
     <button class="btn btn-primary btn-lg btn-block" type="button" data-toggle="collapse" data-target="#CL3" aria-expanded="false" aria-controls="collapseExample">
        <h3>Data</h3>
    </button>
    <div class="collapse show" id="CL3">
        <div class="card card-body setReadOnly">
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="card">
                        <div class="card-header">
                            <asp:CheckBox ID="cbStep5_1" runat="server" Text="  1.Mass NG --> Good" Enabled="false" />
                        </div>

                        <div class="form-inline">
                            <div class="col-auto">
                                <asp:RadioButton ID="rbStep5A1" runat="server" Text="เปลี่ยน Socket" GroupName="GroupStep5" Enabled="false" />
                            </div>
                            &nbsp;&nbsp;&nbsp;
                    <div class="col-auto">
                        <asp:RadioButton ID="rbStep5A2" runat="server" Text="Request PM" GroupName="GroupStep5" Enabled="false" />
                    </div>
                            &nbsp;&nbsp;&nbsp;
                    <div class="form-inline col-auto">
                        <asp:RadioButton ID="rbStep5A3" runat="server" Text="อื่นๆ" GroupName="GroupStep5" />
                        &nbsp;
                        <asp:TextBox ID="tbS5" runat="server" CssClass="form-control blackLine" Enabled="false"></asp:TextBox>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <asp:CheckBox ID="cbStep5_2" runat="server" Text="  2.Good --> NG" Enabled="false" />
                </div>
                <div>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;Request TE</p>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <asp:CheckBox ID="cbStep5_3" runat="server" Text="  3.NG --> NG , Good --> Good" Enabled="false" />
                </div>
                <div>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;Request TE</p>
                </div>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS7" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
            ...
            <div class="card">
                <div class="card-header"><b>*ออกใบ AQI ?</b></div>
                <select class="custom-select wide" id="SelectS15A1" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" Enabled="false"></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" Enabled="false"></asp:TextBox>
            </div>
            ...
            <div class="card">
                <div class="card-header"><b>QC Judgment ?</b></div>
                <asp:TextBox ID="tbS21" runat="server" CssClass="form-control wideOnly" TextMode="MultiLine" placeholder="กรอกรายละเอียด" Enabled="false"></asp:TextBox>
            </div>
