...
{
    public partial class InputPageUser7_Test : System.Web.UI.Page
    {
        ...
        public void SetValue()
        {
            ...
            {
                //this is normal case
                gc.Status = "7"; // Go to PD.Mgr

                //ยกเลิกFlow Move Lot
                //if (SelectS9.SelectedIndex == 5)
                //{   //if Step9 Select TE take back =  Move Lot
                //    gc.Status = "ML3";
                //}
            }
            ...
            {
                gc.JudgementResult = "HOLD : " + tbS17.Text;
            }


            //############################### SET STEP 19 #######################
            if (SelectS19.SelectedIndex == 0)
            {
                gc.LowYieldAnalysis = "";
            }
            else if (SelectS19.SelectedIndex == 1)
            {
                gc.LowYieldAnalysis = "YES";
            }
            else if (SelectS19.SelectedIndex == 2)
            {
                gc.LowYieldAnalysis = "NO";
            }
        ...
        public void ConfirmBtnOnClick(object sender, EventArgs e)
        {
            string strUrl;
            SetValue();
            dba.UpdatePageUser6(gc.Process, gc.HandlerNo, gc.LotNo, gc.Status, gc.JudgementResult, gc.LowYieldAnalysis,
                gc.FYIFQIIncharge_ID, gc.FYIFQIIncharge_Sign, gc.FYIFQIIncharge_SignDate);
