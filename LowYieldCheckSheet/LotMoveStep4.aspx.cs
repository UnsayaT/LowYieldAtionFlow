...
{
    public partial class LotMoveStep4_Test : System.Web.UI.Page
    {
        ...
        {
            ////Message Box
            //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Please Input Number Correctly !!!')", true);

            SetValue();

            dba.MoveLotS4(gc.HandlerNo, gc.LotNo,
           ...
           gc.Bsr9, gc.Bsr9_Missing, gc.Bsr10, gc.BsrTotal, gc.GL_ID,gc.GL_Sign, gc.GL_SignDate);
