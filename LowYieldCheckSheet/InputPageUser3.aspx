<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser3.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser3_Test" %>
    ...
    <script type="text/javascript">
        ...
        function onlyNumbersWithDot(event, value) {
            ...
            if (charCode > 31 && (charCode < 48 || charCode > 57)) {
                alert(" Please input number or sing dot('.') !!");
                return false;
            }
            else return true;
        }
    ...
    <div class="collapse show" id="CL5">
        <div class="card card-body">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <th scope="col">Test No.</th>
                        <td>
                            <asp:TextBox ID="tbS10r1c1" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c2" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c3" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c4" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c5" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th scope="col">จำนวน NG (PCS)</th>
                        <td>
                            <asp:TextBox ID="tbS10r2c1" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c2" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c3" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c4" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c5" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th rowspan="2" class="align-middle">Bch</th>
                        <th scope="col">Test No.</th>
                        <td>
                            <asp:TextBox ID="tbS10r3c1" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c2" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c3" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c4" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c5" runat="server" CssClass="form-control blackLine"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th scope="col">จำนวน NG (PCS)</th>
                        <td>
                            <asp:TextBox ID="tbS10r4c1" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c2" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c3" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c4" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c5" runat="server" CssClass="form-control blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS10A1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง 99.99" onkeypress="return onlyNumbersWithDot(event,value);"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>ค่า Control LCL (%)</b></div>
                <asp:TextBox ID="tbS10A2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง 99.99" onkeypress="return onlyNumbersWithDot(event,value);"></asp:TextBox>
            </div>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS11A1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);" OnTextChanged="tbS11A1_TextChanged"></asp:TextBox>


                <div class="card-header"><b>NG [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS11A2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>

            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>กด Add on หรือยัง ?</b></div>
                <select class="custom-select wide" id="SelectS11" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS11A3" runat="server" CssClass="form-control wide"></asp:TextBox>

                <div class="card-header"><b>ใคร ?</b></div>
                <asp:TextBox ID="tbS11A4" runat="server" CssClass="form-control wide"></asp:TextBox>


                <div class="card-header"><b>การจัดการอย่างไร ?</b></div>
               <%-- <asp:TextBox ID="tbS11A5" runat="server" CssClass="form-control wideOnly" TextMode="MultiLine" placeholder="รายละเอียดการจัดการ"></asp:TextBox>--%>
                <asp:DropDownList CssClass="form-control wide" ID="SelectS12" runat="server">
                    <asp:ListItem Enabled="true" Text="Please Select"></asp:ListItem>
                    <asp:ListItem Text="FLOW LOT CONTACT NG"></asp:ListItem>
                    <asp:ListItem Text="HOLD QYI"></asp:ListItem>
                </asp:DropDownList>
            </div>
