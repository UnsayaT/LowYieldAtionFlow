<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser6.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser7_Test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function openNewWindows() {
            ...
            //window.open("http://beerserver/LSI/FYI/mainmenu.aspx");
        }
    ...
    <div class="collapse show" id="CL5">
        <div class="card card-body">
            ...
            <div class="card">
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:DropDownList CssClass="form-control wide BgColData" ID="SelectS17" runat="server" AutoPostBack="true" OnSelectedIndexChanged="SelectS17_SelectedIndexChanged">
                            <asp:ListItem Enabled="true" Text="Please Select"></asp:ListItem>
                ...
                <br />
                <asp:TextBox ID="tbS17" runat="server" CssClass="form-control wide BgColData" placeholder="Hold ?"></asp:TextBox>
            </div>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS19" runat="server">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
