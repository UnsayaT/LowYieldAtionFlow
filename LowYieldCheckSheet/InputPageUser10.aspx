 <%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser10.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser10" %>
    ...
    <div class="collapse show" id="CL3">
        <div class="card card-body setReadOnly">
            ...
            <div class="p-3 mb-2 bg-dark text-white">
             ...
             <div class="card">
                <div class="card-header"><b>*ออกใบ AQI ?</b></div>
                <select class="custom-select wide BgColData" id="SelectS15A1" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide BgColData" id="SelectS15A2" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide BgColData" id="SelectS15A3" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A1" runat="server" CssClass="form-control wide BgColData" Enabled="false"></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A2" runat="server" CssClass="form-control wide BgColData" Enabled="false"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>*การชี้ความแน่นอนของ Object Scope ?</b></div>
                <select class="custom-select wide BgColData" id="SelectS18A1" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide BgColData" id="SelectS18A2" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
