<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser5.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser5_Test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        function HideEqpModal() {
            $('#QyiModal').modal('hide');
        }

        function ShowEqpModal() {
            $('#QyiModal').modal('show');
        }

        function openNewWindows() {
            //this fucntion is open url in new tap
            //window.open("http://beerserver/FQI_REC/MainForm.aspx");
        }
...
                                        นั้นการตัดสินขั้นสุดท้าย (Final Judgement) ให้ดำเนินการโดย R/K QC
    ...
    <div class="collapse" id="CL3">
        <div class="card card-body setReadOnly">
            ...
            <div class="card">
                ...
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" ></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" ></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>*การชี้ความแน่นอนของ Object Scope ?</b></div>
                <select class="custom-select wide" id="SelectS18A1" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS18A2" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*มีคำสั่ง Stop Shipment ของ PKG เดียวกัน ?</b></div>
                <select class="custom-select wide" id="SelectS20A1" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <br />
            <div class="card">
                <div class="card-header"><b>*ผลการตรวจสอบ Assy ?</b></div>
                <select class="custom-select wide" id="SelectS20A2" runat="server" disabled>
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
    ...
    <div class="collapse show" id="CL5">
        <div class="card card-body">
                ...
                <ContentTemplate>
                    <div class="col-sm">
                        <div class="card-header">
                            <div class="row">
                                <div class="mx-0">
                                    <b>KANBAN ITEM : FQI NO ANALYSIS</b>
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#QyiModal">QYI Data</button>
                                </div>
                            </div>
                        ...
                        <asp:TextBox ID="tbS13A4" runat="server" CssClass="form-control wide"></asp:TextBox>

                        <div class="card-header"><b>TEST NO</b></div>
                        <asp:TextBox ID="tbS13A5" runat="server" CssClass="form-control wide"></asp:TextBox>

                        <div class="card-header"><b>KANBAN EXPIRE DATE</b></div>

                        <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                            <input type="text" runat="server" id="dateS13" class="form-control datetimepicker-input blackLine" data-target="#datetimepicker2" name="KanbanExpDate" />
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS13A1" runat="server" CssClass="form-control wide" onkeypress="return validatenumerics(event);"></asp:TextBox>
            </div>
            <br />
            <div class="card">
                <div class="card-header"><b>*ผลการตรวจสอบ ?</b></div>
                <div class="card-header"><b>Good (PCS)</b></div>
                <asp:TextBox ID="tbS13A2" runat="server" CssClass="form-control wide" onkeypress="return validatenumerics(event);"></asp:TextBox>
                <div class="card-header"><b>NG (PCS)</b></div>
                <asp:TextBox ID="tbS13A3" runat="server" CssClass="form-control wide" onkeypress="return validatenumerics(event);"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>*ออกใบ AQI ?</b></div>
                <select class="custom-select wide" id="SelectS13A1" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS13A2" runat="server">
                    <option selected>Please Select</option>
            ...
            <div class="card">
                ...
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS14A1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS14A2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS14A3" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS14A4" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
            </div>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS14A5" runat="server" CssClass="form-control wide" onkeypress="return validatenumerics(event);"></asp:TextBox>
                <div class="card-header"><b>NG No.</b></div>
                <asp:TextBox ID="tbS14A6" runat="server" CssClass="form-control wide" onkeypress="return validatenumerics(event);"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>*ออกใบ AQI ?</b></div>
                <select class="custom-select wide" id="SelectS14A1" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*ออกคำสั่ง Stop lot ที่จะผลิตต่อไปหรือยัง ?</b></div>
                <select class="custom-select wide" id="SelectS14A2" runat="server">
                    <option selected>Please Select</option>
                    <option>แจ้งแล้ว</option>
                    <option>ไม่ได้แจ้ง</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS14A3" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*ออกใบ AQI ?</b></div>
                <select class="custom-select wide" id="Select1" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*มีคำสั่ง Stop Shipment ของ Object Device ?</b></div>
                <select class="custom-select wide" id="Select2" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*Stop การออก Label ?</b></div>
                <select class="custom-select wide" id="Select3" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:DropDownList CssClass="form-control wide" ID="SelectS17" runat="server" AutoPostBack="true">
                            <asp:ListItem Enabled="true" Text="Please Select"></asp:ListItem>
                            <asp:ListItem Text="Flow"></asp:ListItem>
                            <asp:ListItem Text="Hold QC"></asp:ListItem>
                            <asp:ListItem Text="Hold FYI"></asp:ListItem>
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
                ...
                <br />
                <asp:TextBox ID="tbS17" runat="server" CssClass="form-control wide" placeholder="Hold ?"></asp:TextBox>
            </div>
            ...
            <div class="card">
                <div class="card-header"><b>*งาน Good FT O/S Retest(ทั้งจำนวน) ?</b></div>
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>*การชี้ความแน่นอนของ Object Scope ?</b></div>
                <select class="custom-select wide" id="Select4" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*คำสั่ง Stop Recall,Stop Shipment ?</b></div>
                <select class="custom-select wide" id="Select5" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*มีคำสั่ง Stop Shipment ของ PKG เดียวกัน ?</b></div>
                <select class="custom-select wide" id="Select6" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                <div class="card-header"><b>*ผลการตรวจสอบ Assy ?</b></div>
                <select class="custom-select wide" id="Select7" runat="server">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
    ...
    <!-- Modal QYI -->
    <div class="modal fade" id="QyiModal" tabindex="-1" role="dialog" aria-labelledby="SaveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="EqpModalLabel">Choose QYI Data</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="auto-style1">
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <asp:GridView CssClass="gridviewFit" ID="GridViewQYI" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Inset" BorderWidth="3px" CellPadding="3"
                                    ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False" AllowPaging="false" DataSourceID="SqlDataSource1" Width="100%" OnRowCommand="GridViewQYI_RowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Date" HeaderText="IssueDate" SortExpression="IssueDate" />
                                        ...
                                        <asp:BoundField DataField="NGTestNo" HeaderText="NG TestNo" SortExpression="TestNo" />
                                        <asp:BoundField DataField="ExpiryDate" HeaderText="ExpiryDate" SortExpression="ExpiryDate" />
                                        <asp:BoundField DataField="Kanbandate" HeaderText="Kanbandate" SortExpression="Kanbandate" Visible="false" />
                                        <asp:TemplateField HeaderText="Choose">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImgBtnChoose" runat="server" Height="30px" Width="30px" ImageUrl="~/Images/Complete.png"
                                                    CommandName="Choose" CommandArgument='<%#Eval("IssueNo") + "|" + Eval("NGTestNo") + "|" +Eval("Kanbandate") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                    </Columns>
                                </asp:GridView>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBxConnectionStringMain %>" SelectCommand=""></asp:SqlDataSource>
