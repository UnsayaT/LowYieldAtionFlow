<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PageMonitoring_QC.aspx.cs" Inherits="LowYieldCheckSheet.PageMonitoring_QC" %>
    ...
    <div class="auto-style1">
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBxConnectionString %>" SelectCommand="SELECT [Process], [HandlerNo], [LotNo], [PackageName], [DeviceName], [RequestDate], [Status], [RequestType], [Flow], [InitialYield], [ControlYield], [FinalYield], [ControlLCL],[CheckAlarmBin],[Mode] FROM [LowYieldActionReport] WHERE (Status='8' OR Status='8B') ORDER BY [RequestDate] DESC"></asp:SqlDataSource>
