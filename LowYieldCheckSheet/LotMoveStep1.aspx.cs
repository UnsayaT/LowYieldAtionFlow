...
{
    public partial class LotMoveStep1_Test : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            tbDate.Value = DateTime.Now.ToString("yyyy/MM/dd HH:mm");
            tbDevice.Value = Request.Params["Device"]; //get parameter from url
            tbLotNo.Value = Request.Params["LotNo"]; //get parameter from url
            tbMCNo.Value = Request.Params["MCNo"]; //get parameter from url
            ...
            if (gc.Edit == "TRUE") //if it's edit mode then
            {
        ...
        protected void btnConfirm_ServerClick(object sender, EventArgs e)
        {
            ...
            if (gc.Edit == "TRUE")
            {
                dba.MoveLotS1Edit(gc.HandlerNo, gc.DeviceName, gc.LotNo, gc.MoveLotReason, gc.RequestMoveDate,
                ...
                gc.Bfb9, gc.Bfb9_Missing, gc.Bfb10, gc.BfbTotal, gc.OPName1_ID, gc.OPName1_Sign, gc.OPName1_SignDate);
            }
            else if (gc.Edit == "FALSE")
            {
                dba.MoveLotS1(gc.HandlerNo, gc.DeviceName, gc.LotNo, gc.MoveLotReason, gc.RequestMoveDate,
                 gc.Bfb1, gc.Bfb1_TgBefore,
                 gc.Bfb2, gc.Bfb2_Good, gc.Bfb2_StdReel, gc.Bfb2_HasuuReel, gc.Bfb3, gc.Bfb3_QTy, gc.Bfb3_Unit, gc.Bfb3_Result,
                 gc.Bfb4, gc.Bfb4_OS, gc.Bfb5, gc.Bfb5_FT, gc.Bfb6, gc.Bfb6_Make, gc.Bfb7, gc.Bfb7_Marker, gc.Bfb8, gc.Bfb8_TP,
                 gc.Bfb9, gc.Bfb9_Missing, gc.Bfb10, gc.BfbTotal, gc.OPName1_ID, gc.OPName1_Sign, gc.OPName1_SignDate);
