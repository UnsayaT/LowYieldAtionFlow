<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LotMoveStep4.aspx.cs" Inherits="LowYieldCheckSheet.LotMoveStep4_Test" %>
            ...
            <div class="card blackLine">
                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB1" name="selectB1" runat="server" onchange="Selectable1()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>TG Before (Pcs)</b>
                        <input type="text" id="tbR1B" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB2" name="selectB2" runat="server" onchange="Selectable2()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>Good (Pcs)</b>
                        <input type="text" id="tbR2B1" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled />

                        <b>Std Reel</b>
                        <input type="text" id="tbR2B2" runat="server" class="wide BgColData" onkeypress="return validatenumerics(event);" disabled />

                        <b>Hasuu reel</b>
                        <input type="text" id="tbR2B3" runat="server" class="wide BgColData" onkeypress="return validatenumerics(event);" disabled />
                    </div>
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB3" name="selectB3" runat="server" onchange="Selectable3()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>Q'Ty (Frame)</b>
                        <input type="text" id="tbR3B1" runat="server" class="wide BgColData" onchange="Multiply(),getTotal()" onkeypress="return validatenumerics(event);" disabled/>

                        <b>Unit (Pcs/Frame)</b>
                        <input type="text" id="tbR3B2" runat="server" class="wide BgColData" onchange="Multiply(),getTotal()" onkeypress="return validatenumerics(event);" disabled/>

                        <b>Result (Pcs)</b>
                        <input type="text" id="tbR3B3" runat="server" class="wide BgColData" onblur="getTotal()" onkeypress="return validatenumerics(event);" disabled />
                    </div>
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB4" name="selectB4" runat="server" onchange="Selectable4()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>O/S (Pcs)</b>
                        <input type="text" id="tbR4B" runat="server" class="wide BgColData" onblur="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB5" name="selectB5" runat="server" onchange="Selectable5()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>F/T (Pcs)</b>
                        <input type="text" id="tbR5B" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB6" name="selectB6" runat="server" onchange="Selectable6()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>Make (Pcs)</b>
                        <input type="text" id="tbR6B" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled />
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB7" name="selectB7" runat="server" onchange="Selectable7()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>Marker (Pcs)</b>
                        <input type="text" id="tbR7B" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled />
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB8" name="selectB8" runat="server" onchange="Selectable8()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>TP (Pcs)</b>
                        <input type="text" id="tbR8B" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled />
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB9" name="selectB9" runat="server" onchange="Selectable9()">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
                        <br />
                        <b>Missing (Pcs)</b>
                        <input type="text" id="tbR9B" runat="server" class="wide BgColData" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled />
                    ...
                    <div class="card">
                        ...
                        <select class="custom-select wide BgColData" id="selectB10" name="selectB10" runat="server">
                            <option selected>Please Select</option>
                            <option>มี</option>
                            <option>ไม่มี</option>
                        </select>
