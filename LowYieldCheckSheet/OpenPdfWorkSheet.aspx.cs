...
{
    public partial class OpenPdfWorkSheet : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            tbl = dba.PullByMCNoAndLotNo(Request.Params["Process"], Request.Params["MCNo"], Request.Params["LotNo"]);
            //tbl = dba.PullByMCNoAndLotNo("FL", "FL-F-001", "1817A2290V");
            ...
            if (tbl.Rows.Count == 1)
            {
                ...
                foreach (DataRow row in tbl.Rows)
                {
                    ...
                    if (!(string.IsNullOrEmpty(row["ManaulCheck1"].ToString())))
                    {
                        ...
                        else if (row["ManaulCheck2"].ToString() == "REQUESTPM")
                        {
                            //วาดวงรี Draw Oval
                        ...
                        else
                        {
                            ...
                            aPCB.ShowText(row["ManaulCheck3"].ToString());
                            aPCB.EndText();
                        }
                    }
                    aPCB.Stroke();
