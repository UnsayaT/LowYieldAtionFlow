<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PageMonitoring_GL.aspx.cs" Inherits="LowYieldCheckSheet.PageMonitoring_GL" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1 class="text-center login-title" style="font-family: 'Waffle Regular'; font-weight: bold;">MONITORING FOR GROUP LEADER</h1>
    </div>
    ...
    <div class="auto-style1">
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBxConnectionString %>" SelectCommand="SELECT [Process], [HandlerNo], [LotNo], [PackageName], [DeviceName], [RequestDate], [Status], [RequestType], [Flow], [InitialYield], [ControlYield], [FinalYield], [ControlLCL],[CheckAlarmBin],[Mode] FROM [LowYieldActionReport] WHERE (Status='4' or Status='ML2' or Status='ML4') ORDER BY [RequestDate] DESC"></asp:SqlDataSource>
