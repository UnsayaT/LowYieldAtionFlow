<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PageMonitoring_QYI.aspx.cs" Inherits="LowYieldCheckSheet.PageMonitoring_QYI" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1 class="text-center login-title" style="font-family: 'Waffle Regular'; font-weight: bold;">MONITORING FOR QYI</h1>
    </div>
    ...
    <div class="auto-style1">
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBxConnectionString %>" SelectCommand="SELECT [Process], [HandlerNo], [LotNo], [PackageName], [DeviceName], [RequestDate], [Status], [RequestType], [Flow], [InitialYield], [ControlYield], [FinalYield], [ControlLCL],[CheckAlarmBin],[Mode] FROM [LowYieldActionReport] WHERE (Status='5' or Status='5A' or Status='5B' or Status='6') ORDER BY [RequestDate] DESC"></asp:SqlDataSource>
