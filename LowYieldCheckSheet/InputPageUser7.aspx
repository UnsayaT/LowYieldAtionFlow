<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser7.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser7_Test1" %>
    ...
    <div class="collapse show" id="CL3">
        <div class="card card-body setReadOnly">
            ...
            <div class="card">
                ...
                <br />
                <div class="row mx-2">
                    <asp:CheckBox CssClass="mx-auto" runat="server" ID="CheckS7A1" Text="Bin 28" Enabled="false"/>
                    <asp:CheckBox CssClass="mx-auto" runat="server" ID="CheckS7A2" Text="Bin 29" Enabled="false"/>
                    <asp:CheckBox CssClass="mx-auto" runat="server" ID="CheckS7A3" Text="Bin 30" Enabled="false"/>
                    <asp:CheckBox CssClass="mx-auto" runat="server" ID="CheckS7A4" Text="Bin 31" Enabled="false"/>
                    <asp:CheckBox CssClass="mx-auto" runat="server" ID="CheckS7A5" Text="ไม่มี" Enabled="false"/>
                </div>
            </div>
