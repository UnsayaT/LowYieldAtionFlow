<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LotMoveStep1.aspx.cs" Inherits="LowYieldCheckSheet.LotMoveStep1_Test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        ...
        <input type="text" id="tbReason" runat="server" class="wide" />
    </div>
    ...
    <div class="card blackLine">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select1" name="select1" runat="server" onchange="Selectable1()">
                ...
                <br /><br />
                <b>TG Before (Pcs)</b>
                <input type="number" id="tbR1" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            </div>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select2" name="select2" runat="server" onchange="Selectable2()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>Good (Pcs)</b>
                <input type="number" id="tbR2A1" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>

                <b>Std Reel</b>
                <input type="number" id="tbR2A2" runat="server" class="wide" onkeypress="return validatenumerics(event);" disabled/>

                <b>Hasuu reel</b>
                <input type="number" id="tbR2A3" runat="server" class="wide" onkeypress="return validatenumerics(event);" disabled/>
            </div>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select3" name="select3" runat="server" onchange="Selectable3()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>Q'Ty (Frame)</b>
                <input type="number" id="tbR3A1" runat="server" class="wide" onchange="Multiply(),getTotal()" onkeypress="return validatenumerics(event);" disabled/>

                <b>Unit (Pcs/Frame)</b>
                <input type="number" id="tbR3A2" runat="server" class="wide" onchange="Multiply(),getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select4" name="select4" runat="server" onchange="Selectable4()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>O/S (Pcs)</b>
                <input type="number" id="tbR4" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            </div>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select5" name="select5" runat="server" onchange="Selectable5()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>F/T (Pcs)</b>
                <input type="number" id="tbR5" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select6" name="select6" runat="server" onchange="Selectable6()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>Make (Pcs)</b>
                <input type="number" id="tbR6" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select7" name="select7" runat="server" onchange="Selectable7()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>Marker (Pcs)</b>
                <input type="number" id="tbR7" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select8" name="select8" runat="server" onchange="Selectable8()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>TP (Pcs)</b>
                <input type="number" id="tbR8" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select9" name="select9" runat="server" onchange="Selectable9()">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
                <br /><br />
                <b>Missing (Pcs)</b>
                <input type="number" id="tbR9" runat="server" class="wide" onchange="getTotal()" onkeypress="return validatenumerics(event);" disabled/>
            ...
            <div class="card-body">
                ...
                <select class="custom-select wide" id="select10" name="select10" runat="server">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
            ...
            <div class="card-body">
                ...
                <input type="number" id="tbTotal" runat="server" class="wide" onfocus="getTotal()" onkeypress="return validatenumerics(event);" />
            </div>
