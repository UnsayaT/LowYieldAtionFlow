<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InputPageUser4.aspx.cs" Inherits="LowYieldCheckSheet.InputPageUser4_Test" %>
    ...
    <div class="collapse show" id="CL5">
        <div class="card card-body">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <th scope="col">Test No.</th>
                        <td>
                            <asp:TextBox ID="tbS10r1c1" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c2" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c3" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c4" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r1c5" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th scope="col">จำนวน NG (PCS)</th>
                        <td>
                            <asp:TextBox ID="tbS10r2c1" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c2" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c3" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c4" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r2c5" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th rowspan="2" class="align-middle">Bch</th>
                        <th scope="col">Test No.</th>
                        <td>
                            <asp:TextBox ID="tbS10r3c1" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c2" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c3" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c4" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r3c5" runat="server" CssClass="form-control BgColData blackLine"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th scope="col">จำนวน NG (PCS)</th>
                        <td>
                            <asp:TextBox ID="tbS10r4c1" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c2" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c3" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c4" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tbS10r4c5" runat="server" CssClass="form-control BgColData blackLine" placeholder="pcs" onkeypress="return validatenumerics(event);"></asp:TextBox></td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS10A1" runat="server" CssClass="form-control wide BgColData" onkeypress="return onlyNumbersWithDot(event,value);"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>ค่า Control LCL (%)</b></div>
                <asp:TextBox ID="tbS10A2" runat="server" CssClass="form-control wide BgColData" onkeypress="return onlyNumbersWithDot(event,value);"></asp:TextBox>
            </div>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS11A1" runat="server" CssClass="form-control wide BgColData" placeholder="ตัวอย่าง: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>


                <div class="card-header"><b>NG [จำนวน/จำนวน](PCS) </b></div>
                <asp:TextBox ID="tbS11A2" runat="server" CssClass="form-control wide BgColData" placeholder="ตัวอย่าง: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
            ...
            <div class="card">
                ...
                <select class="custom-select wide BgColData" id="SelectS11" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <asp:TextBox ID="tbS11A3" runat="server" CssClass="form-control wide BgColData"></asp:TextBox>

                <div class="card-header"><b>ใคร ?</b></div>
                <asp:TextBox ID="tbS11A4" runat="server" CssClass="form-control wide BgColData"></asp:TextBox>


                <div class="card-header"><b>การจัดการอย่างไร ?</b></div>
                <asp:TextBox ID="tbS11A5" runat="server" CssClass="form-control wideOnly BgColData" TextMode="MultiLine" placeholder="รายละเอียดการจัดการ"></asp:TextBox>
            </div>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS15A2" runat="server">
                    <option selected>Please Select</option>
                    <option>Yes</option>
                    <option>No</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS15A3" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <div class="card-header"><b>Good      [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A1" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
                <div class="card-header"><b>NG        [จำนวน/จำนวน](PCS)</b></div>
                <asp:TextBox ID="tbS18A2" runat="server" CssClass="form-control wide" placeholder="ตัวอย่าง :: 5/10" onkeypress="return onlyNumbersWithSlash(event,value);"></asp:TextBox>
            </div>

            <br />
            <div class="card">
                <div class="card-header"><b>*การชี้ความแน่นอนของ Object Scope ?</b></div>
                <select class="custom-select wide" id="SelectS18A1" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS18A2" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS20A1" runat="server">
                    <option selected>Please Select</option>
                    <option>ทำแล้ว</option>
                    <option>ไม่ได้ทำ</option>
                </select>
            ...
            <div class="card">
                ...
                <select class="custom-select wide" id="SelectS20A2" runat="server">
                    <option selected>Please Select</option>
                    <option>มี</option>
                    <option>ไม่มี</option>
                </select>
